...
impl Clock for RtcFastClock {
    fn frequency(&self) -> MegahertzU32 {
        match self {
            RtcFastClock::RtcFastClockXtalD4 => MegahertzU32::Hz(40_000_000 / 4),
            RtcFastClock::RtcFastClock8m => MegahertzU32::Hz(8_500_000),
        }
    }
}
...
impl Clock for RtcSlowClock {
    fn frequency(&self) -> MegahertzU32 {
        match self {
            RtcSlowClock::RtcSlowClockRtc => MegahertzU32::Hz(1_500_000),
            RtcSlowClock::RtcSlowClock32kXtal => MegahertzU32::Hz(32768),
            RtcSlowClock::RtcSlowClock8mD256 => MegahertzU32::Hz(8_500_000 / 256),
        }
    }
}
...
impl RtcClock {
    ...
    fn calibrate_internal(cal_clk: RtcCalSel, slowclk_cycles: u32) -> u32 {
        ...
        let us_time_estimate = MegahertzU32::MHz(slowclk_cycles) / expected_freq.frequency();
...
impl Rwdt {
    ...
    fn cycles_to_1ms(&mut self) -> u16 {
        ...
        let q_to_float = |period_13q19: u32| (period_13q19 as f32) / ((1 << 19) as f32);
...
impl WatchdogEnable for Rwdt {
    ...
    {
        let rtc_cntl = unsafe { &*RTC_CNTL::ptr() };
        let timeout_raw = (period.into().to_millis() * (self.cycles_to_1ms() as u64)) as u32;
